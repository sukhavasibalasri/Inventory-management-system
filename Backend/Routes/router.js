...
router.post("/insertproduct", async (req, res) => {
    const { ProductName, ProductPrice, ProductBuyPrice, ProductBarcode, ProductStock, ProductSold } = req.body;
    ...
    try {
        ...
        if (pre) {
            ...
            const addProduct = new products({ ProductName, ProductPrice, ProductBuyPrice, ProductBarcode, ProductStock, ProductSold })
...
router.put('/updateproduct/:id', async (req, res) => {
    ...
    try {
        const updateProducts = await products.findByIdAndUpdate(req.params.id, { ProductName, ProductPrice, ProductBuyPrice, ProductBarcode, ProductStock, ProductSold }, { new: true });
